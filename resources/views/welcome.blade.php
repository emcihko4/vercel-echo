...
<div class="w3-main" style="margin-left:300px">
  ...
  <div id="modal01" class="w3-modal w3-black" style="padding-top:0" onclick="this.style.display='none'">
    ...
    <div class="w3-modal-content w3-animate-zoom w3-center w3-transparent w3-padding-64">
      <img id="https://scontent.fcrk4-2.fna.fbcdn.net/v/t39.30808-6/434355071_2102155466809621_3785855796656723637_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeHFBAc0uyOhMhhvuiORDB81Powkw515VHM-jCTDnXlUc0pWJGHVY-PMoN5dc_S97ZDUcLyIj62LxlvqRyoavwQT&_nc_ohc=10mcZxS0ZxMQ7kNvgEoVWBD&_nc_ht=scontent.fcrk4-2.fna&cb_e2o_trans=t&oh=00_AYCQBZoy_H8rKOW5a95wtRJDPnp8wEac1KBQ4DrQe5tPWQ&oe=664FD302" class="w3-image">
      <p id="caption"></p>
    </div>
  </div>
